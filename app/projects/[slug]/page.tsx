    ...
    <div className="min-h-screen bg-background overflow-x-clip">
      ...
      <article className="container mx-auto px-4 max-w-7xl mt-8 sm:mt-10 md:mt-12 relative z-10">
        ...
        <div className="bg-background/95 backdrop-blur-sm rounded-lg border border-border p-5 sm:p-8 md:p-12 mb-8 md:dark:bg-neutral-900/60 md:dark:border md:dark:border-neutral-800/60">
          ...
          {/* Metadata row */}
          <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground dark:text-foreground/70 mb-6">
        ...
        <div className="flex gap-8">
          ...
          <div className="flex-1 min-w-0">
              ...
              <div className="prose prose-neutral dark:prose-invert max-w-none 
                ...
                dark:prose-li:text-foreground/75
                dark:prose-blockquote:text-foreground/75
                dark:prose-a:text-foreground/85
                dark:prose-code:text-foreground/80
                dark:prose-th:text-foreground/85
                dark:prose-td:text-foreground/80
                dark:prose-strong:text-foreground/90">
                {content}
              </div>
